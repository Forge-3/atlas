  ...
  <form onSubmit={handleSubmit(handleCreateOrEditSpace)}>
    <div className="container mx-auto my-4">
      <div className="w-full px-3">
        <div className="relative w-full rounded-xl bg-black/20 mb-1">
          <div className="px-4 py-6 sm:px-8 sm:py-8">
            ...
            <div className="sm:hidden lg:mt-2">
              <div className="flex items-center gap-2">
                <div
                  className={`${
                    !avatarImg ? "bg-primary/20" : null
                  } flex rounded-2xl lg:rounded-3xl p-0.5 lg:p-1 w-21 lg:w-20 h-20 flex-none`}
                >
                    ...
                    >
                      {avatarImg ? (
                        <div className="relative w-full h-full">
                          ...
                          />
                          <div className="font-medium text-white absolute inset-0 flex items-center justify-center text-xs">
                            <RiGalleryUploadFill size={16} />
                          </div>
                        </div>
                      ) : (
                        <div className="rounded-3xl w-full h-full text-[10px] text-white flex flex-col items-center justify-center gap-1 text-center font-montserrat font-medium">
                ...
                <div className="flex-1">
                  ...
                  >
                    {!backgroundImg && (
                      <div className="bg-primary/20 w-full h-20 rounded-xl lg:rounded-3xl flex items-center justify-center relative">
                        <div className="flex items-center justify-center">
                          <div className="text-sm text-white flex items-center justify-center gap-1 font-montserrat font-medium">
                            <RiGalleryUploadFill size={20} />
                            Cover Photo
                          </div>
                        </div>
                    ...
                    {backgroundImg && (
                      <div
                        className="w-full h-20 rounded-xl lg:rounded-3xl bg-right bg-no-repeat bg-cover flex items-center justify-center relative"
                        style={{ backgroundImage: `url('${backgroundImg}')` }}
                      >
                        <div className="flex items-center justify-center">
                          <div className="text-sm text-white items-center justify-center gap-1 font-montserrat font-medium flex flex-col">
                            <RiGalleryUploadFill size={20} />
                            Change Cover Photo
                          </div>
                        </div>
            ...
            <div className="hidden sm:block">
              <div className="relative">
                ...
                >
                  {!backgroundImg && (
                    <div className="bg-primary/20 w-full h-40 sm:h-52 rounded-3xl flex items-center justify-center relative">
                      <div className="flex items-center justify-center">
                  ...
                  {backgroundImg && (
                    <div
                      className="w-full h-40 sm:h-52 rounded-3xl bg-right bg-no-repeat bg-cover flex items-center justify-center relative"
                      style={
                        backgroundImg
                    ...
                    >
                      <div className="flex items-center justify-center">
                        <div className="text-xl text-white items-center justify-center gap-1 font-montserrat font-medium flex flex-col">
                          <RiGalleryUploadFill size={40} />
                          Change Cover Photo
                        </div>
                      </div>
            ...
            <div className="flex flex-col sm:flex-row mt-4 items-center sm:items-start">
              <div
                className={`${
                  !avatarImg ? "bg-primary/20" : `bg-white`
                } hidden sm:flex rounded-3xl p-1 sm:p-0 w-32 h-32 sm:w-28 sm:h-28 flex-none mb-4 sm:mb-0 mr-1 sm:mr-4`}
              >
                <div className="flex flex-1 items-center justify-center">
                  <Dropzone
                    options={{
              ...
              <div className="my-1 text-white font-montserrat flex-1 w-full">
                <div className="relative bg-primary/20 mb-2 pt-8 pb-2 rounded-xl">
                ...
                <div className="relative pt-8 pb-4 bg-primary/20 rounded-xl">
                  <p className="absolute left-4 top-2 text-base sm:text-xl">
                    Bio:
                  </p>
                  <textarea
                    {...register("spaceDescription")}
                    className="bg-transparent outline-none px-4 pb-8 font-medium text-sm sm:text-lg w-full resize-none overflow-hidden"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-4 font-montserrat font-medium w-full text-white mt-1 sm:mt-2">
                  <div className="flex flex-col">
                    <div className="flex gap-2 items-center">
                      <div className="p-2 bg-primary/20 rounded-xl flex-none">
                        <FaDiscord size={24} />
                      </div>
                      <input
                        {...register("spaceDiscord")}
                        className="p-2 bg-primary/20 outline-none rounded-xl my-1 sm:my-2 w-full text-sm sm:text-base"
                ...
                <div className="my-4 flex justify-center lg:justify-end px-0 sm:px-3">
                  {parsedSpacePrincipal ? (
                    didUserCanAdministrate && (
                      <Button
                        variant="primary"
                        className="flex-1 px-10 lg:px-8 md:flex-none font-medium"
                      >
                        Edit space
                      </Button>
                    )
                    ...
                    <Button
                      variant="primary"
                      className="px-10 lg:px-8 font-medium"
                    >
                      Create space
                    </Button>
                  )}
