export const idlFactory = ({ IDL }) => {
  ...
  Error.fill(
    IDL.Variant({
      ...
      'ReferralRewardsLimitReached' : IDL.Null,
      ...
      'ReferralAlreadyExists' : IDL.Null,
      'TaskExpired' : IDL.Null,
      'InvalidReferral' : IDL.Text,
  ...
  const ReferralEntry = IDL.Record({
  ...
  const ClosedTask = IDL.Record({
    ...
    'affiliate_uses' : IDL.Nat64,
    'task_title' : IDL.Text,
    'refunded' : IDL.Bool,
    'token_reward' : TokenReward,
    'referrals' : IDL.Vec(IDL.Tuple(IDL.Principal, ReferralEntry)),
    'end_time' : IDL.Nat64,
    'start_time' : IDL.Nat64,
  ...
  return IDL.Service({
    ...
    'register_task_referral' : IDL.Func(
